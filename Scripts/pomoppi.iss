...
OutputBaseFilename=Pomoppi-Setup-{#MyAppVersion}_Windows
Compression=lzma
...
[Tasks]
; Checked by default. Inno remembers the choice (UsePreviousTasks), so a
; silent self-update keeps whatever the user picked on the first install.
