#!/usr/bin/env node
// generate-sprites.js — reads the real Electron art data
// (legacy-electron/renderer/sprites.js, renderer/friends.js via sprites.js,
// renderer/background.js) and emits
...
const SPRITES = require(path.join(__dirname, '../../legacy-electron/renderer/sprites.js'));
const { BACKGROUNDS, BACKGROUND_IDS } = require(path.join(__dirname, '../../legacy-electron/renderer/background.js'));
...
// Do not hand-edit. Source: legacy-electron/renderer/sprites.js,
// legacy-electron/renderer/friends.js, legacy-electron/renderer/background.js.
// Re-run \`node native/Scripts/generate-sprites.js\` after those change.
