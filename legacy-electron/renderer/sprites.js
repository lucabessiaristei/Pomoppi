...
const ICONS = {
	...
	// Two arrows ("<<"), not skip's arrow-and-bar mirrored — a bar-plus-
	// arrow read too easily as the same glyph as skip at 13px, just facing
	// the other way. Two stacked chevrons reads as "rewind" on sight.
	reset: [
		"0000000000000",
		"0000000000000",
		"0000000000000",
